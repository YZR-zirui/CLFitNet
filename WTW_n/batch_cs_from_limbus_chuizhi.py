...
# ===================== 配置（请修改） =====================
IMAGE_FOLDER = r"D:\deeplearning\WTW\seg_ak"  # 必填：分割图/原图所在文件夹（需与 CSV 的 file 列对应）
CSV_PATH     = r"D:\deeplearning\WTW\results\WTW_new_process\limbus_wtw_results.csv"  # 必填：batch_limbus_wtw.py 导出的 CSV（含 xL_px,yL_px,xR_px,yR_px 或毫米坐标）
OUT_CSV      = r"D:\deeplearning\WTW\results\cs_new_process\cv.cvs"  # 必填：输出 CS 结果 CSV
SAVE_PREVIEW = True
PREVIEW_DIR  = r"D:\deeplearning\WTW\results\cs_new_process"  # 可留空；留空则默认 IMAGE_FOLDER/cs_preview
